...
const IcAgile = () => {
  const courses = [
    { id: 1, imgurl: img1, alt: "", title: "SA SAFe5", description: "text" },
    { id: 2, imgurl: img2, alt: "", title: "SSM SAFe5", description: "text" },
    { id: 3, imgurl: img3, alt: "", title: "SASM SAFe5", description: "text" },
    { id: 4, imgurl: img4, alt: "", title: "POPM SAFe5", description: "text" },
    { id: 5, imgurl: img5, alt: "", title: "LPM SAFe5", description: "text" },
  ];
