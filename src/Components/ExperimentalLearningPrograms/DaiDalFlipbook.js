      ...
      <div id="ic-agile-flipbook" className="pt-2 pb-2 pt-md-5 pb-md-5 bg-primary">
        <Container>
          <Row>
            <Col md={12}>
              <div className="">
                <h2 className="text-center text-white">DAI - DAL Flipbook</h2>
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb justify-content-center">
                    ...
                    <li className="breadcrumb-item">DAI - DAL Flipbook</li>
                  </ol>
                </nav>
              </div>
            </Col>
