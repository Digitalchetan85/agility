...
const DaiEacFlipbook = () => {
  ...
  return (
    <>
      <div id="ic-agile-flipbook" class="pt-2 pb-2 pt-md-5 pb-md-5 bg-primary">
        <Container>
          <Row>
            <Col md={12}>
              <div className="pt-5 pb-5">
                <h2 className="text-center text-white">DAI - EAC Flipbook</h2>
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb justify-content-center">
                    ...
                    <li className="breadcrumb-item">DAI - EAC Flipbook</li>
                  </ol>
                </nav>
              </div>
            </Col>
